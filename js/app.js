...
function init() {
  ...
  // Si la sesion actual tiene score invalido (> 30), descartarla
  var sesionRaw = cargarLocal();
  if (sesionRaw && sesionRaw.diag && sesionRaw.diag.scoreReset > 30) {
    try { localStorage.removeItem(STORAGE_KEY); } catch(e) {}
    sesionRaw = null;
  }
  var sesion = sesionRaw;
